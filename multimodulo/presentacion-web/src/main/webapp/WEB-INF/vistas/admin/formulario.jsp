...
<form action="admin/formulario" method="post" novalidate class="needs-validation">
	<fieldset>
		...
		<div class="row mb-3">
			...
			<div class="col-sm">
				<input type="text" required class="form-control ${producto.errores.nombre != null ? 'is-invalid': '' }" id="nombre" name="nombre"
		...
		<div class="row mb-3">
			...
			<div class="col-sm">
				<textarea maxlength="2000" class="form-control ${producto.errores.descripcion != null ? 'is-invalid': '' }" id="descripcion" name="descripcion">${producto.descripcion}</textarea>
